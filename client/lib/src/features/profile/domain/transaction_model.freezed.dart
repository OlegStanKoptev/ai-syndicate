...
abstract class $TransactionModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, int amount, String investorId});
}
...
class _$_TransactionModel implements _TransactionModel {
  const _$_TransactionModel(
      {required this.id, required this.amount, required this.investorId});
  ...
  @override
  String toString() {
    return 'TransactionModel(id: $id, amount: $amount, investorId: $investorId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, amount, investorId);
...
abstract class _TransactionModel implements TransactionModel {
  const factory _TransactionModel(
      ...
      required final String investorId}) = _$_TransactionModel;
